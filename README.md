...
Currently working at Cynch AI via https://github.com/karlmutch-cynch.  Previously worked on [StudioML, and the LEAF AI platform layer](https://github.com/leaf-ai/studio-go-runner) as well as other commercial and private projects. My work projects are using Istio with gRPC and Buf.Build, Kubernetes (GPU) for ML, Go.  [LinkedIn](https://linkedin.com/in/karlmutch).  I have worked on platforms for Robotics, ML infrastructure and MLOps, IoT, Speech recognition, and genome sequencing.
